...
- List cards from a stack/lane read-only with `deck list --board <id-or-title> --lane <id-or-title>`, `deck list --board <id-or-title> --stack <id-or-title>`, or `deck card list --board <id-or-title> --stack <id-or-title>`.
- Treat lane as a synonym for stack/list column. Use numeric IDs when titles are ambiguous. Board and stack title selectors resolve exact title, case-insensitive exact title, then unique case-insensitive substring.
...
- Prefer read-only commands for smoke checks: `deck board list`, `deck list --board <id-or-title>`, `deck list --board <id-or-title> --lane <id-or-title>`, `deck card list --board <id-or-title> --stack <id-or-title>`, `deck list find --board <id-or-title> --title TEXT`, `deck auth profiles`.
